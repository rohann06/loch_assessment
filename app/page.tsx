...
export default function Home() {
  return (
    <main className=" md:flex items-center h-screen overflow-x-hidden ">
      {/* Detail side */}
      <div className=" h-screen md:w-[55.56%] bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-[#1FA911] from-[18%] via-[#2F15D0] via-[60%] to-[rgb(0,0,0)] to-[90%] xl:pt-10">
        <div className=" flex flex-col w-full pl-[62px] ">
          ...
          {/* 2ndsection */}
          <div className=" flex items-center justify-between mt-[52px] pr-[65px]">
          ...
          <div className="  w-full z-10">
            ...
            <div className=" border border-[#E5E5E6] h-[1px] mr-[65px]" />
