...
export default function Home() {
  return (
    <main className=" md:flex items-center md:h-screen overflow-x-hidden">
      {/* Detail side */}
      <div className=" md:h-screen md:w-[55.56%] bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-[#1FA911] from-[18%] via-[#2F15D0] via-[60%] to-[rgb(0,0,0)] to-[90%] z-0">
        <div className=" flex flex-col items-center w-[678px] z-0 mx-auto">
          {/* 1st div */}
          <div className=" flex items-center gap-x-[38px] text-start  w-full">
          ...
          {/* 2nd div */}
          <div className=" flex justify-center xl:gap-x-[55px] gap-x-[38px] items-center text-end mt-[75px]  w-full">
          ...
          <div className="  w-full">
            ...
            <div className=" flex justify-between  items-end gap-x-[40px] w-screen">
              <img
                src="./lochLogo.png"
                alt="logo"
      ...
      {/* Email side */}
      <div className=" md:h-screen md:w-[44.44%] flex justify-center items-center z-10">
